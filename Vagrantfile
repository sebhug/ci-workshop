...
# MacOS and Linux    ci.vm.network "private_network", ip: "192.168.99.101", :name => 'vboxnet0', :adapter => 2
    ci.vm.network "private_network", ip: "192.168.99.101", :name => 'VirtualBox Host-Only Ethernet Adapter', :adapter => 2    worker.vm.provision :shell, path: "bootstrap.sh"
